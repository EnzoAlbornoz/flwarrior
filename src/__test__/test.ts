...
test("test set Entry On Machine", () => {
    const immutableMachine = buildImmutableRegularNonDeterministicWithoutEpsilonMachine();
    expect((immutableMachine.get("entry") as IIState).equals(Immutable.Map({id: "q0", isEntry: true, isExit: true}))).toBe(true);
...
test("test determinization without ε", () => {
    ...
    expect(
        (immutableMachine.get(
            "transitions"
        ) as Immutable.Set<IITransition>).sort().equals(Immutable.Set([
            Immutable.Map({ from: "s", with: "1", to: "p", push: null, pop: null }),
            Immutable.Map({ from: "q,r", with: "0", to: "r,s", push: null, pop: null }),
            Immutable.Map({ from: "q,r,s", with: "0", to: "r,s", push: null, pop: null }),
            Immutable.Map({ from: "q,r,s", with: "1", to: "p,q,r", push: null, pop: null }),
            Immutable.Map({ from: "r", with: "0", to: "s", push: null, pop: null }),
            Immutable.Map({ from: "r,s", with: "0", to: "s", push: null, pop: null }),
            Immutable.Map({ from: "r", with: "1", to: "p", push: null, pop: null }),
            Immutable.Map({ from: "r,s", with: "1", to: "p", push: null, pop: null }),
            Immutable.Map({ from: "q", with: "1", to: "q,r", push: null, pop: null }),
            Immutable.Map({ from: "q,s", with: "0", to: "r", push: null, pop: null }),
            Immutable.Map({ from: "q", with: "0", to: "r", push: null, pop: null }),
            Immutable.Map({ from: "p", with: "1", to: "q", push: null, pop: null }),
            Immutable.Map({ from: "p,q,r", with: "1", to: "p,q,r", push: null, pop: null }),
            Immutable.Map({ from: "p", with: "0", to: "q,s", push: null, pop: null }),
            Immutable.Map({ from: "p,q,r", with: "0", to: "q,r,s", push: null, pop: null }),
            Immutable.Map({ from: "q,s", with: "1", to: "p,q,r", push: null, pop: null }),
            Immutable.Map({ from: "q,r", with: "1", to: "p,q,r", push: null, pop: null }),
        ]).sort())
    ).toBe(true);
    ...
    expect(
        ...
        >).equals(Immutable.Map({
            ...
            "q,r": Immutable.Map({ id: "q,r", isEntry: false, isExit: true }),
            "q,s": Immutable.Map({ id: "q,s", isEntry: false, isExit: true }),
            "r,s": Immutable.Map({ id: "r,s", isEntry: false, isExit: true }),
            "p,q,r": Immutable.Map({ id: "p,q,r", isEntry: false, isExit: true }),
            "q,r,s": Immutable.Map({ id: "q,r,s", isEntry: false, isExit: true }),
        }))
    ).toBe(true);
    ...
    expect(
        ...
        >).equals(Immutable.Map({
            ...
            "q1,q2": Immutable.Map({ id: "q1,q2", isEntry: false, isExit: true }),
        }))
    ).toBe(true);
    ...
    expect(
        (immutableMachine.get(
            "transitions"
        ) as Immutable.Set<IITransition>).equals(Immutable.Set([
            Immutable.Map({ from: "q1,q2", with: "1", to: "q1,q2", push: null, pop: null }),
            Immutable.Map({ from: "q1", with: "0", to: "q1,q2", push: null, pop: null }),
            Immutable.Map({ from: "q0", with: "1", to: "q1", push: null, pop: null }),
            Immutable.Map({ from: "q2", with: "0", to: "q2", push: null, pop: null }),
            Immutable.Map({ from: "q0", with: "0", to: "q0", push: null, pop: null }),
            Immutable.Map({ from: "q2", with: "1", to: "q1,q2", push: null, pop: null }),
            Immutable.Map({ from: "q1,q2", with: "0", to: "q1,q2", push: null, pop: null }),
            Immutable.Map({ from: "q1", with: "1", to: "q1", push: null, pop: null }),
        ]))
    ).toBe(true);
    ...
    expect(
        ...
        >).equals(Immutable.Map({
            ...
            "q2,q4": Immutable.Map({ id: "q2,q4", isEntry: false, isExit: true }),
            "q1,q3": Immutable.Map({ id: "q1,q3", isEntry: false, isExit: true }),
        }))
    ).toBe(true);
    ...
    expect(
        (immutableMachine.get(
            ...
            Immutable.Map({ from: "q1,q3", with: "1", to: "q1", push: null, pop: null }),
            Immutable.Map({ from: "q2,q4", with: "1", to: "q2,q4", push: null, pop: null }),
            Immutable.Map({ from: "q2,q4", with: "0", to: "q2", push: null, pop: null }),
            Immutable.Map({ from: "q2", with: "0", to: "q2", push: null, pop: null }),
            Immutable.Map({ from: "q1", with: "0", to: "q1,q3", push: null, pop: null }),
            Immutable.Map({ from: "q2", with: "1", to: "q2,q4", push: null, pop: null }),
            Immutable.Map({ from: "q0", with: "0", to: "q1", push: null, pop: null }),
            Immutable.Map({ from: "q0", with: "1", to: "q2", push: null, pop: null }),
            Immutable.Map({ from: "q1,q3", with: "0", to: "q1,q3", push: null, pop: null }),
            Immutable.Map({ from: "q1", with: "1", to: "q1", push: null, pop: null }),
        ]))
    ).toBe(true);
    ...
    expect(
        ...
        >).equals(Immutable.Map({
            ...
            "q1,q2": Immutable.Map({ id: "q1,q2", isEntry: false, isExit: false }),
        }))
    ).toBe(true);
    expect(
        (immutableMachine.get(
            ...
            Immutable.Map({ from: "q0", with: "a", to: "q1,q2", push: null, pop: null }),
        ]))
    ).toBe(true);
});
...
test("test determinization with ε", () => {
    ...
    expect(
        (machine.get("states") as Immutable.Map<string, IIState>).toSet().isSuperset(Immutable.Set([
            Immutable.Map({ id: "p,q", isEntry: true, isExit: false }) as IIState,
            // Immutable.Map({ id: "p", isEntry: false, isExit: false }),
            Immutable.Map({ id: "q,r", isEntry: false, isExit: true }) as IIState,
            Immutable.Map({ id: "p,q,r", isEntry: false, isExit: true }) as IIState,
            Immutable.Map({ id: "r", isEntry: false, isExit: true }) as IIState,
        ]))
    ).toBe(true);

    expect(
        (machine.get("transitions") as Immutable.Set<IITransition>).equals(Immutable.Set([
            Immutable.Map({ from: "p,q", with: "c", to: "p,q,r", push: null, pop: null }),
            Immutable.Map({ from: "q,r", with: "a", to: "p,q", push: null, pop: null }),
            Immutable.Map({ from: "q", with: "c", to: "q", push: null, pop: null }),
            Immutable.Map({ from: "q", with: "c", to: "p", push: null, pop: null }),
            Immutable.Map({ from: "q,r", with: "c", to: "p,q", push: null, pop: null }),
            Immutable.Map({ from: "p", with: "b", to: "q", push: null, pop: null }),
            Immutable.Map({ from: "q", with: "a", to: "q", push: null, pop: null }),
            Immutable.Map({ from: "p,q,r", with: "b", to: "q,r", push: null, pop: null }),
            Immutable.Map({ from: "q", with: "a", to: "p", push: null, pop: null }),
            Immutable.Map({ from: "p,q", with: "b", to: "q,r", push: null, pop: null }),
            Immutable.Map({ from: "p", with: "c", to: "r", push: null, pop: null }),
            Immutable.Map({ from: "p,q", with: "a", to: "p,q", push: null, pop: null }),
            Immutable.Map({ from: "q", with: "b", to: "r", push: null, pop: null }),
            Immutable.Map({ from: "p,q,r", with: "c", to: "p,q,r", push: null, pop: null }),
            Immutable.Map({ from: "q,r", with: "b", to: "r", push: null, pop: null }),
            Immutable.Map({ from: "p,q,r", with: "a", to: "p,q", push: null, pop: null }),
        ]))
    ).toBe(true);
    ...
    expect(
        (machine.get("states") as Immutable.Map<string, IIState>).toSet().isSuperset([
            Immutable.Map({ id: "q0,q3,q4", isEntry: true, isExit: false }) as IIState,
            Immutable.Map({ id: "q0,q1,q3,q4", isEntry: false, isExit: true }) as IIState,
            Immutable.Map({ id: "q2,q3", isEntry: false, isExit: true }) as IIState,
            Immutable.Map({ id: "q2,q3,q4", isEntry: false, isExit: true }) as IIState,
            Immutable.Map({ id: "q1,q3,q4", isEntry: false, isExit: true }) as IIState,
        ])
    ).toBe(true);

    expect(
        (machine.get("transitions") as Immutable.Set<IITransition>).equals(Immutable.Set([
            Immutable.Map({ from: "q3", with: "a", to: "q3", push: null, pop: null }),
            Immutable.Map({ from: "q1", with: "b", to: "q3", push: null, pop: null }),
            Immutable.Map({ from: "q0", with: "a", to: "q4", push: null, pop: null }),
            Immutable.Map({
                from: "q2,q3,q4",
                with: "a",
                to: "q1,q3,q4",
            ...
            Immutable.Map({ from: "q0", with: "a", to: "q3", push: null, pop: null }),
            Immutable.Map({ from: "q3", with: "b", to: "q2", push: null, pop: null }),
            Immutable.Map({
                from: "q1,q3,q4",
                with: "a",
                to: "q1,q3,q4",
            ...
            Immutable.Map({ from: "q1", with: "b", to: "q4", push: null, pop: null }),
            Immutable.Map({ from: "q4", with: "a", to: "q4", push: null, pop: null }),
            Immutable.Map({ from: "q1", with: "a", to: "q4", push: null, pop: null }),
            Immutable.Map({ from: "q1", with: "a", to: "q3", push: null, pop: null }),
            Immutable.Map({
                from: "q2,q3,q4",
                with: "b",
                to: "q2,q3,q4",
            ...
            Immutable.Map({ from: "q0", with: "b", to: "q2", push: null, pop: null }),
            Immutable.Map({ from: "q2", with: "b", to: "q3", push: null, pop: null }),
            Immutable.Map({
                from: "q0,q1,q3,q4",
                with: "a",
                to: "q0,q1,q3,q4",
            ...
            Immutable.Map({ from: "q1", with: "a", to: "q1", push: null, pop: null }),
            Immutable.Map({ from: "q2", with: "b", to: "q2", push: null, pop: null }),
            Immutable.Map({ from: "q3", with: "b", to: "q3", push: null, pop: null }),
            Immutable.Map({ from: "q3", with: "a", to: "q1", push: null, pop: null }),
            Immutable.Map({ from: "q4", with: "b", to: "q2", push: null, pop: null }),
            Immutable.Map({ from: "q3", with: "b", to: "q4", push: null, pop: null }),
            Immutable.Map({ from: "q3", with: "a", to: "q4", push: null, pop: null }),
            Immutable.Map({ from: "q2", with: "b", to: "q4", push: null, pop: null }),
            Immutable.Map({ from: "q4", with: "a", to: "q3", push: null, pop: null }),
            Immutable.Map({ from: "q0", with: "a", to: "q0", push: null, pop: null }),
            Immutable.Map({
                from: "q0,q3,q4",
                with: "a",
                to: "q0,q1,q3,q4",
            ...
            Immutable.Map({ from: "q0", with: "a", to: "q1", push: null, pop: null }),
        ]))
    ).toBe(true);
});
